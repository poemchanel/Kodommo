      ...
      case "admin":
        ...
        switch (tmp.toLowerCase()) {
          case "on":
            ...
            res = { caption: `${statusscrapupdate.status}` };
            break;
          case "off":
            statusscrapupdate = await AutoOff();
            res = {
              caption: `${statusscrapupdate.status}
...
Sedang dalam Antrian ke ${statusscrapupdate.antrian + 1}`,
          ...
          case "log":
            statusscrapupdate = await AutoCek();
            res = {
              caption: `${statusscrapupdate.log.join(`\r\n`)}`,
            };
            break;
          case "":
            res = { caption: `Harap perintah setelah !Auto. contoh !Auto cek` };
            break;
          default:
            res = { caption: `Perintah tidak ditemukan, list perintah !Auto : on , off, cek` };
            break;
        }
        break;
